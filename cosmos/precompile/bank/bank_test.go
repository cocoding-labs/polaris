...
var _ = Describe("Bank Precompile Test", func() {
	...
	When("Calling Precompile Methods", func() {
		...
		BeforeEach(func() {
			ctx = vm.NewPolarContext(ctx, nil, common.Address{1}, common.BytesToAddress(acc), big.NewInt(0))
		})
		...
		When("Send", func() {
			It("should succeed", func() {
				...
				pCtx := vm.NewPolarContext(ctx, nil, common.Address{1}, common.BytesToAddress(fromAcc), new(big.Int))
